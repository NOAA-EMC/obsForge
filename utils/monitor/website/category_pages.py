...
class CategoryGenerator:
    ...
    def generate(self, run_type):
        ...
        for category in categories:
            ...
            filename = f"{run_type}_NOAA_{safe_cat}.html"
            self._write_NOAA_category_page(run_type, category, filename)
    ...
    def _write_NOAA_category_page(self, run_type, category, filename):
        """Generates the detail page for a category, listing all Obs Spaces with plots."""
        ...
        for obs_space in obs_spaces:
            ...
            cycle_id = current_cycle_name
            v_path = self.data.get_product_relative_path(
                "obs_space_NOAA_volume",
                obs_space,
                run_type,
                cycle_id,
            )
            print(f"VOL PLOT --> {v_path}")
